...
```{r}
#Not sure if this is right, it creates a tibble with 0 observations.

rmarkdown::render("./Project3.Rmd", output_file = "Social Media Channel.html", 
                  params = list(dataChannel = "data_channel_is_socmed"))

rmarkdown::render("./Project3.Rmd", output_file = "Lifestyle Channel.html", 
                  params = list(dataChannel = "data_channel_is_lifestyle"))

rmarkdown::render("./Project3.Rmd", output_file = "Entertainment Channel.html", 
                  params = list(dataChannel = "data_channel_is_entertainment"))

rmarkdown::render("./Project3.Rmd", output_file = "Business Channel.html", 
                  params = list(dataChannel = "data_channel_is_bus"))

rmarkdown::render("./Project3.Rmd", output_file = "Tech Channel.html", 
                  params = list(dataChannel = "data_channel_is_tech"))

rmarkdown::render("./Project3.Rmd", output_file = "World Channel.html", 
                  params = list(dataChannel = "data_channel_is_world"))
```
...
```{r}
news <- newsOriginal %>% filter(params$dataChannel == 1)
news
```
...
From the table **above**, we can see that `r tableWeekday[1]` articles were published on Monday, `r tableWeekend[2]` were published on Tuesday, `r tableWeekend[3]` on Wednesday, `r tableWeekend[4]` on Thursday, `r tableWeekend[5]` on Friday, `r tableWeekend[6]` on Saturday, `r tableWeekend[7]` articles were published on Sunday.
...
```{r}
#interestChannel <- c("data_channel_is_socmed", "data_channel_is_lifestyle", "data_channel_is_entertainment", "data_channel_is_bus", "data_channel_is_tech", "data_channel_is_world")
